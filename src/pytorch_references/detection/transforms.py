...
class RandomGaussianBlurring(T.GaussianBlur):
    def __init__(self, p=0.1, kernel_size=(5, 9), sigma=(0.1, 5)):
        self.p = p
        super(RandomGaussianBlurring, self).__init__(kernel_size=kernel_size, sigma=sigma)
