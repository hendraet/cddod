...
# NOTE This file was called from torchvision.ops in the original code
# however this was was missing from my torch code. So I created the file here for
# easiness, otherwise, each of us has to copy this to our installed torchvision
# ops manually
